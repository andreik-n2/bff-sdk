...
import { OperationExecutionEngine } from '@virgograph/protobuf';
...
export class BaseTypeScriptDataModel implements Template {
	...
	generate(generationConfig: CodeGenerationConfig): Promise<TemplateOutputFile[]> {
		...
		const graphQLTypeImport = "import type { GraphQLError } from '@virgograph/sdk/client';";
...
const typescriptFunctionsImports = (generationConfig: CodeGenerationConfig): string => {
	...
	return (
		...
		'import type {ExtractInput,ExtractResponse} from "@virgograph/sdk/operations";\n' +
