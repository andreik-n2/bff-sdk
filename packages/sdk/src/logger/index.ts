import { ConfigurationVariable, LogLevel, logLevelFromJSON } from '@virgograph/protobuf';
...
export const Logger = logger.child({ component: '@virgograph/sdk' });
export const ServerLogger = logger.child(
	{ component: '@virgograph/server', ...cloudBindings },
...
export const FatalLogger = initLogger(process.stderr).child({ component: '@virgograph/sdk' });
