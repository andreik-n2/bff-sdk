...
import { createWunderGraphNext as createWunderGraphNextInternal, createHooks, WithWunderGraphOptions, SSRCache } from '@virgograph/nextjs';
import { User } from '@virgograph/sdk/client';
